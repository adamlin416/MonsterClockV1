...
//        fun onEggSelected(monsterId: Int)
//    }
//
...
//        //    .load(resourceId)
//        //    .into(gifImageView)
//        view.findViewById<ImageView>(R.id.eggSelectImageView1).setOnClickListener {
//            val monsterName = it.tag.toString()
//            lifecycleScope.launch(Dispatchers.IO) {
//                val monster = db.monsterDao().getMonsterByName(monsterName.toString())
//                val resourceId = it.context.resources.getIdentifier(monster.pixelGifName, "drawable", it.context.packageName)
...
//                }
//                listener?.onEggSelected(monster.monsterId)
//                dismiss()
//            }
//        }
//        view.findViewById<ImageView>(R.id.eggSelectImageView2).setOnClickListener {
//            val monsterName = it.tag.toString()
//            lifecycleScope.launch(Dispatchers.IO) {
//                val monster = db.monsterDao().getMonsterByName(monsterName.toString())
//                val resourceId = it.context.resources.getIdentifier(monster.pixelGifName, "drawable", it.context.packageName)
...
//            }
//        }
//        view.findViewById<ImageView>(R.id.eggSelectImageView3).setOnClickListener {
//            val monsterName = it.tag.toString()
//            lifecycleScope.launch(Dispatchers.IO) {
//                val monster = db.monsterDao().getMonsterByName(monsterName.toString())
//                val resourceId = it.context.resources.getIdentifier(monster.pixelGifName, "drawable", it.context.packageName)
